...
class Partner(models.Model):
    ...
    partner_CMND_image_front = models.ImageField(blank=True) # ảnh mặt trước CMND
    partner_CMND_image_back = models.ImageField(blank=True) # ảnh mặt sau CMND
    ...
    def admin_photo(self):
        return mark_safe('<img src="/media/%s" style="width: 45px; height:45px;" />' % (self.partner_image.name))
