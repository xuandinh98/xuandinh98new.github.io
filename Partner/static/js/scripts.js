(function ($) {
    ...
    $(document).ready(function () {
        ...
        //     $(".signup-store-province").append("<option value='' selected disabled hidden>Chọn Tỉnh/Thành</option> ");
        //     $(".signup-store-district option").remove();
        //     $(".signup-store-district").append("<option value='' selected disabled hidden>Chọn Quận/Huyện</option> ");
        //     $(".signup-store-wards option").remove();
        //     $(".signup-store-wards").append("<option value='' selected disabled hidden>Chọn Xã/Phường/Thị trấn</option> ");
        //     if($(this).val() == "vietnam") {
        //         // make POST ajax call
        //         $.ajax({
        //             type: 'POST',
        //             url: "post/ajax/postProvinces",
